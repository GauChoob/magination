...
wBattle_LevelUp_Flags::
    ...
    ; Bit 7 - Set if a new command was learned this level, to display in text
    ds 1
    ;ds $D38A - @
...
wBattle_LevelUp_StatIndex::
    ; Was used to calculate the stats level up
    ; But is now deprecated and no longer fully functional
    ; Generated by a number: rand(4)*5, but is 0 past level 62
    ds 1
    ;ds $D38C - @
wBattle_LevelUp_Stats::
    .Strength:
        ds 1
    .Skill:
        ds 1
