...
BITMAP_Font::
    ...
    ; Direct addresses to specific characters
        DEF BITMAP_Font_ArrowRight           EQU $40C0 ; 🡆
        DEF BITMAP_Font_ArrowDown            EQU $40D0 ; 🡇
        DEF BITMAP_Font_SpecimenJar          EQU $40E0 ; 🧴
        DEF BITMAP_Font_HollowStool          EQU $40F0 ; 🪑
        DEF BITMAP_Font_Ring                 EQU $4100 ; 💍
        DEF BITMAP_Font_InfusedAnimite       EQU $4110 ; 🌟
        DEF BITMAP_Font_Animite              EQU $4120 ; 💰
        DEF BITMAP_Font_Spell                EQU $4130 ; 📜
        DEF BITMAP_Font_Drink                EQU $4140 ; 🥣
        DEF BITMAP_Font_UNKNOWNJar           EQU $4150 ; 🍯
        DEF BITMAP_Font_BalooLeaf            EQU $4160 ; 🍃
        DEF BITMAP_Font_LuckFlower           EQU $4170 ; 🌻
        DEF BITMAP_Font_BalooRootCloudFrond  EQU $4180 ; 🌴
        DEF BITMAP_Font_PlodSpnewMushroom    EQU $4190 ; 🍄
        DEF BITMAP_Font_Gem                  EQU $41A0 ; 💎
        DEF BITMAP_Font_Relic                EQU $41B0 ; ❓
        DEF BITMAP_Font_Energy               EQU $41C0 ; Σ
        DEF BITMAP_Font_FatArrow             EQU $41D0 ; ◿
        DEF BITMAP_Font_Key                  EQU $41E0 ; 🔑
    ...
    ; $5000
BITMAP_Sprite_NumberBounce::
    ; The numbers that pop up when a creature takes damage
    INCBIN "autogenerated/assets/sprites/cardscenefx/NumberBounce.tileset"
...
sMenu_MainMenu_Blat::
    ...
    ; $52C0
    ; todo
    db "Which ring do youwant to act on?LvlEXBuySel💰Donex◿ItemsSplRic◿Done"
...
Menu_MainMenu_SetRelicString:
    ; Given a creature struct, get the name of a relic (the first letter is stripped since it's assumed to be ❓)
...
Menu_MainMenu_DrawCurrentTop::
    ...
    jr nz, .CheckTONY_
        .Index_INFUSED:
            ...
            ; Loop through the 5 entries, and remove the 🌟NAME if the name is blank, since the 🌟 was pre-set by the tilemap
...
Menu_MainMenu_Setup_Rings:
    ...
    ; Write the 2 relics' names (skip the first char "❓")
