...
AI_Blocker_PlaceTile::
    ...
    ; TODO
    ldh a, [hAI_HeroFlags_Current]                                  ; $4AD5: $F0 $AB
    bit 1, a                                      ; $4AD7: $CB $4F
    ret z                                         ; $4AD9: $C8
...
Jump_001_4B7B:
    ...
    ld a, [wAI_CntDown]                                 ; $4B7E: $FA $A4 $C9
    bit 0, a                                      ; $4B81: $CB $47
    ret z                                         ; $4B83: $C8

    pop af                                        ; $4B84: $F1
    ldh a, [hAI_HeroFlags_Next]                                  ; $4B85: $F0 $AA
    set 2, a                                      ; $4B87: $CB $D7
    ldh [hAI_HeroFlags_Next], a                                  ; $4B89: $E0 $AA
    ld a, [hl]                                    ; $4B8B: $7E
    ld e, a                                       ; $4B8C: $5F
    cp $0B                                        ; $4B8D: $FE $0B
...
Jump_001_4BCC:
    ...
    ld a, [wAI_CntDown]                                 ; $4BCF: $FA $A4 $C9
    bit 0, a                                      ; $4BD2: $CB $47
    ret z                                         ; $4BD4: $C8

    pop af                                        ; $4BD5: $F1
    ldh a, [hAI_HeroFlags_Next]                                  ; $4BD6: $F0 $AA
    set 2, a                                      ; $4BD8: $CB $D7
    ldh [hAI_HeroFlags_Next], a                                  ; $4BDA: $E0 $AA
    ld a, [hl]                                    ; $4BDC: $7E
    ld e, a                                       ; $4BDD: $5F
    cp $0B                                        ; $4BDE: $FE $0B
...
Jump_001_4C1D:
    ...
    ld a, [wAI_CntDown]                                 ; $4C20: $FA $A4 $C9
    bit 0, a                                      ; $4C23: $CB $47
    ret z                                         ; $4C25: $C8

    pop af                                        ; $4C26: $F1
    ldh a, [hAI_HeroFlags_Next]                                  ; $4C27: $F0 $AA
    set 2, a                                      ; $4C29: $CB $D7
    ldh [hAI_HeroFlags_Next], a                                  ; $4C2B: $E0 $AA
    ld a, [hl]                                    ; $4C2D: $7E
    ld e, a                                       ; $4C2E: $5F
    cp $0B                                        ; $4C2F: $FE $0B
...
Jump_001_4C6E:
    ...
    ld a, [wAI_CntDown]                                 ; $4C71: $FA $A4 $C9
    bit 0, a                                      ; $4C74: $CB $47
    ret z                                         ; $4C76: $C8

    pop af                                        ; $4C77: $F1
    ldh a, [hAI_HeroFlags_Next]                                  ; $4C78: $F0 $AA
    set 2, a                                      ; $4C7A: $CB $D7
    ldh [hAI_HeroFlags_Next], a                                  ; $4C7C: $E0 $AA
    ld a, [hl]                                    ; $4C7E: $7E
    ld e, a                                       ; $4C7F: $5F
    cp $0B                                        ; $4C80: $FE $0B
...
Jump_001_4D3C:
    ...
    ld [hl], a                                    ; $4DA3: $77
    Do_CallForeign Call_007_4ADF
    ld hl, hAI_HeroFlags_Next                                  ; $4DAC: $21 $AA $FF
    set 3, [hl]                                   ; $4DAF: $CB $DE
...
Jump_001_4EF2:
    ...
    ld a, [wAI_CntDown]                                 ; $4F17: $FA $A4 $C9
    bit 6, a                                      ; $4F1A: $CB $77
...
Jump_001_4F9C:
    ...
    ld a, [wAI_CntDown]                                 ; $4FC1: $FA $A4 $C9
    bit 4, a                                      ; $4FC4: $CB $67
...
Jump_001_5046:
    ...
    ld a, [wAI_CntDown]                                 ; $506B: $FA $A4 $C9
    bit 5, a                                      ; $506E: $CB $6F
...
Jump_001_50F0:
    ...
    ld a, [wAI_CntDown]                                 ; $5115: $FA $A4 $C9
    bit 7, a                                      ; $5118: $CB $7F
...
Jump_001_5B6E:
    ...
    ld a, [wAI_CntDown]                                 ; $5B9C: $FA $A4 $C9
    bit 0, a                                      ; $5B9F: $CB $47
...
Call_001_5DE1:
    ...
    ld hl, hAI_HeroFlags_Next                                  ; $5DEA: $21 $AA $FF
    set 1, [hl]                                   ; $5DED: $CB $CE
    SwitchRAMBank $05
...
Call_001_5E3E:
    ld a, [wAI_CntDown]                                 ; $5E3E: $FA $A4 $C9
    bit 0, a                                      ; $5E41: $CB $47
    ret z                                         ; $5E43: $C8
...
jr_001_5EC3:
    ...
    ldh a, [hAI_HeroFlags_Current]                                  ; $5ED5: $F0 $AB
    bit 3, a                                      ; $5ED7: $CB $5F
    ret z                                         ; $5ED9: $C8
...
Jump_001_6167:
    ...
    ld a, [wAI_CntDown]                                 ; $618F: $FA $A4 $C9
    bit 0, a                                      ; $6192: $CB $47
...
Call_001_641D:
    ldh a, [hAI_HeroFlags_Current]                                  ; $641D: $F0 $AB
    bit 2, a                                      ; $641F: $CB $57
...
Call_001_651A:
    xor a                                         ; $651A: $AF
    ldh [hAI_HeroFlags_Next], a                                  ; $651B: $E0 $AA
    ldh [hAI_HeroFlags_Current], a                                  ; $651D: $E0 $AB
...
AI_Idle::
    ...
    ld hl, hAI_HeroFlags_Next                                  ; $65F7: $21 $AA $FF
    set 1, [hl]                                   ; $65FA: $CB $CE
