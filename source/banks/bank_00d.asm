...
jr_00D_5DDB:
    ...
    ; $5DE0
BITMAP_Sprite_MoragBattle::
    INCBIN "autogenerated/assets/sprites/morag/MoragBattle.tileset", 0, $0250

    ; $6030
BITMAP_Sprite_OgarBattle::
    ; Bug - the first tile of this file is referred to by the .spr file for BITMAP_Sprite_MoragBattle
...
jr_00D_6A0F:
    ...
    ; $6A30
BITMAP_Sprite_Sparkle::
    INCBIN "autogenerated/assets/sprites/objects/sparkle/Sparkle.tileset"
