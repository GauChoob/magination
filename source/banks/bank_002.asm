...
Jump_002_65CC:
    ...
    Do_Battle_SetActorScript [wBattle_CurCreature_Slot], SCRIPT_ANIM_Stone
    Do_CallForeign Call_005_5575
    ld a, $49                                     ; $6600: $3E $49
...
Battle_Flow_StatusAilments::
    ...
    jr z, .CheckErupt
        .Plague:
            Do_Battle_SetActorScript [$D0B6], SCRIPT_ANIM_Plague
    ...
    jp nc, .NotAttack
        ...
        jr z, .CheckHiddenMirror
            ...
            jr z, .StoneNotEarth
                .StoneEarth:
                    ...
                    Do_Battle_SetActorScript [wBattle_Creature_Current.BattleCmd_Target], SCRIPT_ANIM_Stone
        ...
        jr nz, .CheckHiccupsWater
            .PlagueFire:
                ...
                ; Cure Plague
                Do_Battle_SetActorScript [wBattle_Creature_Current.BattleCmd_Target], SCRIPT_ANIM_Plague
...
INCLUDE "source/game/battle/battle_script_xx.asm"
