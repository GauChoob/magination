...
.\1:
    ...
    db \<26> ; AbilityLevel3
    db \<27> ; AbilityLevel4
    AddressBank BITMAP_Fightscene_Creature_\<28>RLE ; Fightscene Tileset
    AddressBank ATTRTILE_Fightscene_Creature_\<28>RLE ; Fightscene Attrtilemap
    db \<29> ; AttrTilemap Width
