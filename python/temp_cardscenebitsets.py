...
rom = utils.Rom()
sym = utils.SymFile()
sym.replaceSymbol(0x0D, 0x6A30, 'BITMAP_Battle_Summon')
sym.replaceSymbol(0x41, 0x6250, 'BITMAP_Battle_CardsceneFX')
sym.replaceSymbol(0x24, 0x5990, 'BITMAP_Battle_Tony')
sym.replaceSymbol(0x24, 0x6140, 'BITMAP_Battle_Togoth')
sym.replaceSymbol(0x0D, 0x6030, 'BITMAP_Battle_Ogar')
sym.replaceSymbol(0x24, 0x5D70, 'BITMAP_Battle_Korremar')
sym.replaceSymbol(0x24, 0x6310, 'BITMAP_Battle_Warrada')
sym.replaceSymbol(0x0A, 0x61F0, 'BITMAP_Battle_Korg')
sym.replaceSymbol(0x0d, 0x6e70, 'BITMAP_Battle_Zet')
sym.replaceSymbol(0x0D, 0x5DE0, 'BITMAP_Battle_Morag')
sym.replaceSymbol(0x24, 0x4030, 'BITMAP_Battle_Agram')
sym.replaceSymbol(0x24, 0x4750, 'BITMAP_Battle_ShadowMagi1')
sym.replaceSymbol(0x24, 0x4990, 'BITMAP_Battle_ShadowMagi2')
sym.replaceSymbol(0x24, 0x4bd0, 'BITMAP_Battle_ShadowMagi3')
sym.replaceSymbol(0x24, 0x4d10, 'BITMAP_Battle_ShadowMagi4')
sym.replaceSymbol(0x24, 0x4ec0, 'BITMAP_Battle_ShadowMagi5')
sym.replaceSymbol(0x24, 0x5080, 'BITMAP_Battle_ShadowMagi6')
sym.replaceSymbol(0x24, 0x5230, 'BITMAP_Battle_ShadowMagi7')
sym.replaceSymbol(0x24, 0x53e0, 'BITMAP_Battle_ShadowMagi8')
sym.replaceSymbol(0x24, 0x5F60, 'BITMAP_Battle_Salafy')
...
for i, (name, discard_count) in enumerate(names):
    ...
    for bitmap in bitset.contents.bitmaps[0]:
        if bitmap.label_name in ['BITMAP_Battle_Summon', 'BITMAP_Battle_CardsceneFX']:
            continue
