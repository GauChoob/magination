...
def fix_backslash(path: str) -> str:
    """
    Change \ to /
    """
    return path.replace('\\', '/')
...
def remove_autogenerated(path: str) -> str:
    """
...
def reverse_pattern(path: str) -> str:
    """
