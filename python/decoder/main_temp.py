...
rom = utils.Rom()
bitsets = [
    (0x75D0,"CardsceneTogath"),
    (0x7594,"CardsceneOgar"),
    (0x7558,"CardsceneKorremar"),
    (0x75EE,"CardsceneWarranda"),
    (0x753A,"CardsceneKorg"),
    (0x760C,"CardsceneZet"),
    (0x7576,"CardsceneMorag"),
    (0x742C,"CardsceneAgram"),
    #(0x742C,"CardsceneAgram"),
    #(0x742C,"CardsceneAgram"),
    (0x744A,"CardsceneShadowMagi63"),
    (0x7468,"CardsceneShadowMagi64"),
    (0x7486,"CardsceneShadowMagi65"),
    (0x74A4,"CardsceneShadowMagi66"),
    (0x74C2,"CardsceneShadowMagi67"),
    (0x74E0,"CardsceneShadowMagi68"),
    (0x74FE,"CardsceneShadowMagi69"),
    (0x751C,"CardsceneShadowMagi70"),
    (0x75B2,"CardsceneSalafy"),
    #(0x75B2,"CardsceneSalafy"),
]
# Iterate over all the scenes, which covers about 1100/1170 of all the assets
nameoverride = False
print("BITSETS")
for x in range(len(bitsets)):
    adr = bitsets[x][0]
    name = bitsets[x][1]
    print(utils.BankAddress(0x04,adr))
    ParseAssets(rom,utils.BankAddress(0x04,adr),"HeaderTileset",name)
