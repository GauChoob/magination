...
# If GHOST_DATA is enabled (in game.asm), insert the unused file fragments into the sample data at MUSYX_BANK + 1

with open(r"source\game.asm", "r") as f:
    found = False
    for line in f:
...
# For RGBDS v0.7.0, we need to add DEF to all the EQU in SoundIDs.asm
# We also write the total number of SFXs and SONGs
with open(r"autogenerated\musyx\SoundIDs.asm", "r") as f:
    soundids = f.read()
...
with open(r"autogenerated\musyx\SoundIDs.asm", "w") as f:
    f.write(soundids)
